...
Quaternion GetAngle(const ImuData_t *pMpu, float dt)
{
    ...
    // 转换为物理单位
    float ax = (float)pMpu->accX / 4096.0f;
    float ay = (float)pMpu->accY / 4096.0f;
    float az = (float)pMpu->accZ / 4096.0f;
    
    float gx = (float)pMpu->gyroX * Gyro_Gr;
    float gy = (float)pMpu->gyroY * Gyro_Gr;
    float gz = (float)pMpu->gyroZ * Gyro_Gr;
